...
def test_hyperparameters(classifier, X_train, y_train):
    ...
    if classifier == 'Random Forest':
        parameters = {'n_estimators': [100, 300, 500], "max_depth": [3, 5, 7, None], 
        ...
        parameters = {'hidden_layer_sizes': [(100,), (300,), (500,)], 
                      'solver': ['sgd', 'adam'],
    ...
    clf = RandomizedSearchCV(classification, parameters, scoring="%s_macro" % score, cv=3)
